...
} // for another live path
elseif(strpos($host, "#") !== FALSE) {
    $config['base_url'] = 'https://iplus-data.com/';
}
else { // for common live path
    $config['base_url'] = 'https://iplus-data.com';
}
...
|
*/
$config['encryption_key'] = 'dashboard.iplus.data.encryption.key';
...
$config['csrf_token_name'] = 'iplus-data-csrf_test_name';
$config['csrf_cookie_name'] = 'iplus-data-csrf_cookie_name';
