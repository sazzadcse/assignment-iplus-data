...
<html lang="en">
	<head>
		...
		<script>
			...
			var division_id = "<?php echo $this->input->get('applicant_division'); ?>";
			var district_id = "<?php echo $this->input->get('applicant_district'); ?>";
			var upazila_id = "<?php echo $this->input->get('applicant_upazila'); ?>";
		</script>
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">iplus</span>
							Application &copy; 2004-2022
						</span>
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				if( division_id != '' ){
					append_district_by_division(division_id, district_id);
				}
				if( district_id != '' ){
					console.log('mounted');
					append_upazila_by_district(district_id, upazila_id);
				}
			
			});

			function append_district_by_division($division_id, $district_id){
			...
			function append_upazila_by_district($district_id, $upazila_id){
