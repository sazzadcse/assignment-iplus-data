...
var $iplusFronted = {
    ...
    regForm     : "#iplus_user_registration_form",
    ...
    init_iplusFronted: function($){

        jQuery(document).ready(function($) {

            $iplusFronted.init_district_options();
            $iplusFronted.init_upazila_options();
            $iplusFronted.append_more_education();
            $iplusFronted.append_more_training();
            $iplusFronted.toggole_training();
            $iplusFronted.validate_registration_form();
    ...
    init_district_options : function () {
        ...
        if ( $iplusFronted.divisionEl ) {

            $( $iplusFronted.divisionEl ).on( 'change', function(){

                $('#applicant_upazila').html('<option>Select Upazila/Thana..</option>');

                var $division_id = $( $iplusFronted.divisionEl ).val();
    ...
    init_upazila_options : function () {
        ...
        if ( $iplusFronted.districtEl ) {

            $( $iplusFronted.districtEl ).on( 'change', function(){

                var $district_id = $( $iplusFronted.districtEl ).val();
    ...
    append_more_education : function(){
        if( $iplusFronted.addMoreEd ){
            $($iplusFronted.addMoreEd).on('click', function(){
                ...
                $education_new_row += $iplusFronted.education_exam_options();
                ...
                $education_new_row += $iplusFronted.education_university_options();
                $education_new_row += '</select>';
                $education_new_row += '</div>';
                ...
                $education_new_row += $iplusFronted.education_boards_options();
                $education_new_row += '</select>';
                $education_new_row += '</div>';
    ...
    append_more_training : function(){
        if( $iplusFronted.addMoreTr ){
            $($iplusFronted.addMoreTr).on('click', function(){
		...
		$($iplusFronted.regForm).validate({
            ...
            submitHandler: function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: $($iplusFronted.regForm).serializeArray(),
                    success: function (response) {
                        var $data = JSON.parse(response);
                        ...
                        if ($data.status == true) {
                            ...
                            $( $iplusFronted.regForm ).each(function(){
                                this.reset();
                            });
...
$iplusFronted.init_iplusFronted();