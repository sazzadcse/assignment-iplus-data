...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2022 at 09:23 PM
...
--
-- Database: `db_assignment_iplus_data`
--
...
CREATE TABLE `applicants` (
  ...
  `applicant_division` int(4) NOT NULL,
  `applicant_district` int(4) NOT NULL,
  `applicant_upazila` int(4) NOT NULL,
  `address_details` text NOT NULL,
  `language_proficiency_bangla` varchar(15) NOT NULL,
  `language_proficiency_english` varchar(15) NOT NULL,
  `language_proficiency_french` varchar(15) NOT NULL,
  `applicant_photo` varchar(256) NOT NULL,
  `applicant_cv` varchar(256) NOT NULL,
  `is_training` enum('yes','no') NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `updated_by` int(4) DEFAULT NULL,
  `status` enum('active','pending','delete') NOT NULL
...
INSERT INTO `applicants` (`id`, `applicant_name`, `applicant_email`, `applicant_division`, `applicant_district`, `applicant_upazila`, `address_details`, `language_proficiency_bangla`, `language_proficiency_english`, `language_proficiency_french`, `applicant_photo`, `applicant_cv`, `is_training`, `created_at`, `updated_at`, `updated_by`, `status`) VALUES
(3, 'Sazzad', 'sazzad@gmail.com', 1, 1, 1, 'Sirajgong Sadar', 'bangla', 'english', '', '', '', 'yes', '2022-08-03 08:26:28', '0000-00-00 00:00:00', NULL, 'active'),
(4, 'Mr. Golam Mostofa', 'sazzadtbd@gmail.com', 2, 14, 123, 'Chalopar, Bogra Sadar', 'bangla', 'bangla', '', '4_103388134362f147e5d80c3.jpg', '4_', 'yes', '2022-08-03 08:37:46', '2022-08-08 19:54:11', 1, 'active'),
(5, 'Sakil Khan', 'sakil@gmail.com', 3, 20, 171, 'AD', 'bangla', 'english', '', '', '', 'yes', '2022-08-08 11:40:54', '0000-00-00 00:00:00', NULL, 'active'),
(6, 'Milon Ahammed', 'milon@gmail.com', 7, 54, 404, 'Milon Address Details', 'bangla', 'english', '', '', '', 'yes', '2022-08-08 20:38:04', '0000-00-00 00:00:00', NULL, 'active'),
(7, 'Tarek Khan', 'tarek@gmail.com', 4, 32, 242, 'Pirojpur Sadar', 'bangla', 'english', '', '', '', 'yes', '2022-08-08 20:46:10', '0000-00-00 00:00:00', NULL, 'active'),
(8, 'KM Imran ', 'imran@gmail.com', 3, 22, 186, 'Imran Address Details', 'bangla', 'english', '', '', '', 'yes', '2022-08-08 20:52:44', '0000-00-00 00:00:00', NULL, 'active');
...
CREATE TABLE `applicant_educations` (
  `id` mediumint(20) NOT NULL,
  `applicant_id` mediumint(20) NOT NULL,
...
INSERT INTO `applicant_educations` (`id`, `applicant_id`, `exam_name`, `university_name`, `board_name`, `result`, `created_at`, `updated_at`, `updated_by`, `status`) VALUES
(1, 3, '1', '2', '2', 4, '2022-08-03 08:26:28', '0000-00-00 00:00:00', NULL, 'active'),
(2, 4, '1', '1', '1', 4, '2022-08-03 08:37:46', '2022-08-08 19:54:11', 1, 'active'),
(3, 4, '2', '10', '1', 3.5, '2022-08-03 08:37:46', '2022-08-08 19:54:11', 1, 'active'),
(4, 5, '1', '6', '3', 3.75, '2022-08-08 11:40:54', '0000-00-00 00:00:00', NULL, 'active'),
(5, 5, '2', '5', '3', 2.5, '2022-08-08 11:40:54', '0000-00-00 00:00:00', NULL, 'active'),
(6, 6, '1', '1', '1', 5, '2022-08-08 20:38:04', '0000-00-00 00:00:00', NULL, 'active'),
(7, 6, '2', '1', '1', 5, '2022-08-08 20:38:04', '0000-00-00 00:00:00', NULL, 'active'),
(8, 6, '3', '14', '6', 3.5, '2022-08-08 20:38:04', '0000-00-00 00:00:00', NULL, 'active'),
(9, 7, '1', '12', '6', 4, '2022-08-08 20:46:10', '0000-00-00 00:00:00', NULL, 'active'),
(10, 8, '1', '6', '3', 5, '2022-08-08 20:52:44', '0000-00-00 00:00:00', NULL, 'active'),
(11, 8, '2', '5', '3', 3.75, '2022-08-08 20:52:44', '0000-00-00 00:00:00', NULL, 'active');
...
CREATE TABLE `applicant_trainings` (
  `id` mediumint(20) NOT NULL,
  `applicant_id` mediumint(20) NOT NULL,
  `traning_name` varchar(360) NOT NULL,
  `traning_details` text NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `updated_by` int(4) DEFAULT NULL,
  `status` enum('active','pending','delete') NOT NULL
...
INSERT INTO `applicant_trainings` (`id`, `applicant_id`, `traning_name`, `traning_details`, `created_at`, `updated_at`, `updated_by`, `status`) VALUES
(1, 3, 'CI-Professional ', 'Training details here', '2022-08-03 08:26:30', '0000-00-00 00:00:00', NULL, 'active'),
(2, 4, 'WordPress Basic', 'Details of WP Basic - Pro', '2022-08-03 08:37:46', '2022-08-08 19:54:11', 1, 'active'),
(3, 4, 'WordPress Advance', 'Details of WP Advance - Pro', '2022-08-03 08:37:46', '2022-08-08 19:54:11', 1, 'active'),
(4, 5, 'WordPress Basic', 'Training details here for WP Basic', '2022-08-08 11:40:54', '0000-00-00 00:00:00', NULL, 'active'),
(5, 6, 'Basic HRM', 'Basic HRM Details', '2022-08-08 20:38:04', '0000-00-00 00:00:00', NULL, 'active'),
(6, 6, 'Basic HRM Advance', 'Basic HRM Advance Details', '2022-08-08 20:38:04', '0000-00-00 00:00:00', NULL, 'active'),
(7, 7, 'WordPress Basic Traning', 'Training details here for WP Basic', '2022-08-08 20:46:10', '0000-00-00 00:00:00', NULL, 'active'),
(8, 8, 'Basic Training - 1', 'Basic Training - 1 Details', '2022-08-08 20:52:44', '0000-00-00 00:00:00', NULL, 'active'),
(9, 8, 'Basic Training - 2', 'Basic Training - 2 Details', '2022-08-08 20:52:44', '0000-00-00 00:00:00', NULL, 'active');
...
CREATE TABLE `boards` (
  ...
  `status` enum('active','pending','delete') NOT NULL DEFAULT 'active',
  `created_at` datetime NOT NULL,
...
INSERT INTO `boards` (`id`, `name`, `status`, `created_at`, `update_at`) VALUES
(1, 'Dhaka', 'active', '2022-07-31 06:45:38', '2022-07-31 06:45:38'),
(2, 'Rajshahi', 'active', '2022-07-31 06:45:38', '2022-07-31 06:45:38'),
(3, 'Jessore', 'active', '2022-07-31 06:46:20', '2022-07-31 06:46:20'),
(4, 'Chittagong', 'active', '2022-07-31 06:46:56', '2022-07-31 06:46:56'),
(5, 'Sylhet', 'active', '2022-07-31 06:46:56', '2022-07-31 06:46:56'),
(6, 'Barisal', 'active', '2022-07-31 06:47:28', '2022-07-31 06:47:28'),
(7, 'Dinajpur', 'active', '2022-07-31 06:47:28', '2022-07-31 06:47:28'),
(8, 'Madrasah', 'active', '2022-07-31 06:48:10', '2022-07-31 06:48:10');
...
CREATE TABLE `districts` (
  ...
  `district_en` varchar(150) NOT NULL,
  `district_bn` varchar(150) NOT NULL,
...
INSERT INTO `districts` (`id`, `division_id`, `district_en`, `district_bn`, `lat`, `lon`, `url`) VALUES
...
CREATE TABLE `divisions` (
  `id` int(1) NOT NULL,
  `division_en` varchar(150) NOT NULL,
  `division_bn` varchar(150) NOT NULL,
  `url` varchar(50) NOT NULL
...
INSERT INTO `divisions` (`id`, `division_en`, `division_bn`, `url`) VALUES
...
INSERT INTO `examinations` (`id`, `name`, `status`, `created_at`, `updated_at`) VALUES
(1, 'SSC', 'active', '2022-07-31 06:40:59', '2022-07-31 06:40:59'),
(2, 'HSC', 'active', '2022-07-31 06:40:59', '2022-07-31 06:40:59'),
(3, 'BBA', 'active', '2022-07-31 06:41:42', '2022-07-31 06:41:42'),
(4, 'Bsc in Engineering', 'active', '2022-07-31 06:41:42', '2022-07-31 06:41:42'),
(5, 'MBA', 'active', '2022-07-31 06:42:24', '2022-07-31 06:42:24'),
(6, 'MSC in Engineering', 'active', '2022-07-31 06:42:24', '2022-07-31 06:42:24');
...
INSERT INTO `universities` (`id`, `name`, `status`, `created_at`, `update_at`) VALUES
(1, 'University of Dhaka', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(2, 'University of Rajshahi', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(3, 'University of Chittagong', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(4, 'Jahangirnagar University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(5, 'Islamic University, Bangladesh', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(6, 'Khulna University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(7, 'Jagannath University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(8, 'Comilla University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(9, 'Jatiya Kabi Kazi Nazrul Islam University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(10, 'Bangladesh University of Professionals', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(11, 'Begum Rokeya University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(12, 'University of Barisal', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(13, 'Rabindra University, Bangladesh', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(14, 'Sheikh Hasina University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09'),
(15, 'Bangabandhu Sheikh Mujibur Rahman University', 'active', '2022-07-31 06:53:09', '2022-07-31 06:53:09');
...
CREATE TABLE `upazilas` (
  ...
  `upazila_en` varchar(150) NOT NULL,
  `upazila_bn` varchar(150) NOT NULL,
  `url` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `upazilas` (`id`, `district_id`, `upazila_en`, `upazila_bn`, `url`) VALUES
...
INSERT INTO `users` (`user_id`, `user_name`, `displayname`, `email`, `level_id`, `password`, `status`, `create_at`, `update_at`) VALUES
(1, 'admin', 'Admin', 'sazzadtbd@gmail.com', 1, 'e10adc3949ba59abbe56e057f20f883e', 1, '2022-08-08 05:45:04', '2022-08-08 05:45:04');
...
ALTER TABLE `applicants`
  ...
  ADD KEY `applicant_division` (`applicant_division`),
  ADD KEY `applicant_district` (`applicant_district`),
  ADD KEY `applicant_upazila` (`applicant_upazila`),
...
--
ALTER TABLE `applicants`
  MODIFY `id` mediumint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `applicant_educations`
--
ALTER TABLE `applicant_educations`
  MODIFY `id` mediumint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `applicant_trainings`
--
ALTER TABLE `applicant_trainings`
  MODIFY `id` mediumint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `examinations`
  MODIFY `id` mediumint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `universities`
--
ALTER TABLE `universities`
  MODIFY `id` mediumint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `users`
  MODIFY `user_id` mediumint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
